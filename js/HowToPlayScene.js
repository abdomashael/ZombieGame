var HowToPlayScene = new Phaser.Class({
    ...
    create: function () {
        ...
        Textatfinally = this.add.text(0, 700, 'We hope you enjoy our game and We wish you the best of luck beacuse you will need it', { fontSize: '35px', fill: '#ffd800', fontFamily: 'Courier', fontStyle: 'bold italic' });
